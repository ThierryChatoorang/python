...
class Product:
    ...
    @staticmethod
    def from_dict(data):
        return Product(data["naam"], data["prijs"], data["voorraad"])
...
def vraag_int(prompt):
    while True:
        try:
            ...
            print("Ongeldige invoer, probeer een heel getal.")
...
def vraag_float(prompt):
    while True:
        try:
            ...
            print("Ongeldige invoer, probeer een getal.")
